...
public class ServicioMensajeria {
    ...
    /**
     * Función para marcar los envios extraviados, se ejecuta automaticamente a
     * las 12
     */
    ...
    /**
     * Función que obtiene los envíos extraviados, opcionalmente entre un
     * intervalo de fechas.
     *
     * @throws IllegalArgumentException La fecha de inicio debe ser menor que la
     * de fin
     * @param inicio Fecha de inicio, null para obtener todos los envios
     * extraviados
