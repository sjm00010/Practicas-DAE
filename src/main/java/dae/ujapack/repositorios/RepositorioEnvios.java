...
public class RepositorioEnvios {
    ...
    /**
     * Función para listar envios que puedas estar extraviados. No incluye
     * envios ya extraviados ni entregados.
     *
    ...
    /**
     * Función que lista los envios extraviados entre dos fechas, si no se
     * indican devuelve todos los envios extraviados.
     *
